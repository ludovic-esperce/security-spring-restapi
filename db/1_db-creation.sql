...
CREATE ROLE webapi NOSUPERUSER NOCREATEDB NOCREATEROLE NOINHERIT LOGIN NOREPLICATION NOBYPASSRLS PASSWORD '6LXTSaisjymEsc';
GRANT DELETE, UPDATE, SELECT, TRIGGER, INSERT ON TABLE public.booking TO webapi;
GRANT DELETE, UPDATE, SELECT, TRIGGER, INSERT ON TABLE public.client TO webapi;
GRANT DELETE, UPDATE, SELECT, TRIGGER, INSERT ON TABLE public.hotel TO webapi;
GRANT DELETE, UPDATE, SELECT, TRIGGER, INSERT ON TABLE public.room TO webapi;
GRANT DELETE, UPDATE, SELECT, TRIGGER, INSERT ON TABLE public.station TO webapi;
